...
class IDAUp(nn.Module):
    def __init__(self, in_channels_list: Tuple[int], up_factors_list: Tuple[int], out_channels: int):
        super().__init__()
        ...
        for i in range(1, len(in_channels_list)):
            ...
            up = nn.ConvTranspose2d(in_channels=out_channels, out_channels=out_channels,
                                    kernel_size=(up_factors * 2), stride=up_factors,
                                    padding=(up_factors // 2), output_padding=0,
